...
def main():
    ...
    doc={'schema':'polynomial-weighted-pair-six-row-v1','kernel_sha256':hashlib.sha256(base.PRIOR.joinpath('kernel.json').read_bytes()).hexdigest(),
         ...
         'normalization_lower':'19/16','normalization_upper':'4/3','source_relative_accuracy_target':'1/1000','metric':'L2','records':records}
