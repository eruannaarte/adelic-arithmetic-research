...
BANK=(-10,-8,-4,0,4,8,10)
H=Q(1,2000000); DG=Q(1,400000)
ETA=Q(11,10**8); RHO=XI=Q(1,10**9)
MU=Q(1083,51200000000); LAMBDA=Q(361,5120000000000000)
...
def polynomials():
    p=coeff(OLD/'kernel.json');q=coeff(HERE/'kernel_derivative.json')
    return p,q
