...
class StructuredBank:
    def __init__(self):
        ...
        self.prior_check=self.directions['weighted_pair_certificate']
    ...
    def decode(self,raw,nominal_time,actual_time_interval,potential_interval):
        ...
        if len(raw)!=6:raise ValueError('exactly six readings required')
