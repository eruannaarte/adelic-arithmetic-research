...
The most natural next step is adaptive column generation with a rational dual
certificate. It would close the remaining gap between a useful mode detector
and a finite design theorem that certifies its own search domain.
